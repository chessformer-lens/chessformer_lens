...
<style>
  ...
  .pair{font-family:var(--mono);font-size:11px;line-height:1.7;background:#0f131a;
...
<style>
  ...
  .coeffstrip{display:flex;gap:1px;height:54px;background:#0f131a;border:1px solid var(--line);
